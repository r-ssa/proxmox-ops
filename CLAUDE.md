...
- `main` is branch-protected. Work happens on a branch, opened as a PR, for the user to actually read before merging. Never attempt to push directly to `main` or bypass the protection.
